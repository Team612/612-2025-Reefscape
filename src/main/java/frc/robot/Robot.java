...
public class Robot extends TimedRobot {
  ...
  private static final double trackWidth = 0.550;
  private static final double wheelBase = 0.555;
  ...
  private static final double mod0EncoderOffset = 0.1;
  private static final int mod0AngleMotorID = 3;
  private static final int mod0DriveMotorID = 2;
  ...
  private static final double mod1EncoderOffset = 0.1;
  private static final int mod1AngleMotorID = 1;
  private static final int mod1DriveMotorID = 8;
  ...
  private static final double mod2EncoderOffset = 0.1;
  private static final int mod2AngleMotorID = 5;
  private static final int mod2DriveMotorID = 4;
  ...
  private static final double mod3EncoderOffset = 0.1;
  private static final int mod3AngleMotorID = 7;
  private static final int mod3DriveMotorID = 6;
  ...
  public class mySwerveModule{
    ...
    public mySwerveModule(int angleMotorID, int drivingMotorID, int angleEncoderID, double encoderOffset){
      ...
      // default is coast mode which is bad so we set it to brake mode
