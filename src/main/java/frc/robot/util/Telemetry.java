...
public class Telemetry {
    ...
    public void initData(){
        ...
        m_payload = Elevator.getInstance();
        ...
        FRAngle = drivetrainData.getDoubleTopic("FR Voltage").getGenericEntry();
        FLAngle = drivetrainData.getDoubleTopic("FL Voltage").getGenericEntry();
        BRAngle = drivetrainData.getDoubleTopic("BR Voltage").getGenericEntry();
        BLAngle = drivetrainData.getDoubleTopic("BL Voltage").getGenericEntry();
    ...
    public void updateData(){
        ...
        FLAngle.setDouble(m_drivetrain.getSwervePositions()[0].angle.getDegrees());
        FRAngle.setDouble(m_drivetrain.getSwervePositions()[1].angle.getDegrees());
        BLAngle.setDouble(m_drivetrain.getSwervePositions()[2].angle.getDegrees());
        BRAngle.setDouble(m_drivetrain.getSwervePositions()[3].angle.getDegrees());
