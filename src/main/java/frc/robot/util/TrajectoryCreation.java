...
public class TrajectoryCreation {
    ...
    public PathPlannerPath apriltagCentering(PoseEstimator estimation, Vision vision, double displacementX, double displacementY){
        ...
        Pose2d midPose1 = new Pose2d(tagX, tagY, tagAngle).transformBy(new Transform2d(new Translation2d(displacementX-2,displacementY),new Rotation2d()));
        Pose2d midPose2 = new Pose2d(tagX, tagY, tagAngle).transformBy(new Transform2d(new Translation2d(displacementX-2,displacementY+Units.inchesToMeters(12.947811)),new Rotation2d()));
