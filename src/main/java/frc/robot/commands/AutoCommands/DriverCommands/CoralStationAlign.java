...
public class CoralStationAlign extends Command {
  ...
  public CoralStationAlign(PoseEstimator p, Vision v, TrajectoryCreation t, double disX, double disY) {
    m_poseEstimator = p;
    m_vision = v;
    m_traj = t;
    displacementX = disX;
  ...
  public void initialize() {
    ...
    try {
      path = m_traj.coralStationCentering(m_poseEstimator, m_vision);
