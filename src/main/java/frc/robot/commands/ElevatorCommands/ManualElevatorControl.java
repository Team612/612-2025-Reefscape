...
public class ManualElevatorControl extends Command {
  ...
  public ManualElevatorControl(Elevator e) {
    m_elevator = e;
  ...
  public void execute() {
    if (ControlMap.gunner_controls.getRawAxis(0) == 1){
      m_elevator.setMotorSpeed(-ControlMap.gunner_controls.getRawAxis(0) * Constants.ElevatorConstants.payloadDownSpeed);
    }
    else if (ControlMap.gunner_controls.getRawAxis(0) == -1){
      m_elevator.setMotorSpeed(-ControlMap.gunner_controls.getRawAxis(0) * Constants.ElevatorConstants.payloadUpSpeed);
    }
  }
