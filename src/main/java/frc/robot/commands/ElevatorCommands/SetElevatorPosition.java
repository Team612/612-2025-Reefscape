...
public class SetElevatorPosition extends Command {
  ...
  public SetElevatorPosition(Elevator pay,Intake i, double p) {
    m_intake = i;
    m_elevator = pay;
    position = p;
  ...
  public boolean isFinished() {
    ...
    System.out.println("Set Elevator: " + Math.abs(m_elevator.getPosition() - position));
    //System.out.println(Math.abs(m_payload.getPosition() - position));
    return (Math.abs(m_elevator.getPosition() - position) <= Constants.ElevatorConstants.elevatorThreshold);
