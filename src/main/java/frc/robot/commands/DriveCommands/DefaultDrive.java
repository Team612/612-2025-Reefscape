...
public class DefaultDrive extends Command {
  ...
  public void execute() {
    m_drivetrain.RobotOrientedDrive(-ControlMap.driver_controls.getRawAxis(1), ControlMap.driver_controls.getRawAxis(0), ControlMap.driver_controls.getRawAxis(4));
  }
}