...
public class Vision extends SubsystemBase {
  ...
  public Vision() {
    ...
    photonPoseEstimator = new PhotonPoseEstimator(aprilTagFieldLayout, PoseStrategy.MULTI_TAG_PNP_ON_COPROCESSOR, new Transform3d(Constants.SwerveConstants.trackWidth/2,0,0,new Rotation3d())); //instantiates photon pose estimator
