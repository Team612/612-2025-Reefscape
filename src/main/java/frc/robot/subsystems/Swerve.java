...
public class Swerve extends SubsystemBase {
  ...
  public Swerve() {
    ...
    modules = new SwerveModule[] {
      new SwerveModule(0, Constants.SwerveConstants.Mod0.constants, swerveModuleConfigs),
      new SwerveModule(1, Constants.SwerveConstants.Mod1.constants, swerveModuleConfigs),
      new SwerveModule(2, Constants.SwerveConstants.Mod2.constants, swerveModuleConfigs),
      new SwerveModule(3, Constants.SwerveConstants.Mod3.constants, swerveModuleConfigs),
    };
