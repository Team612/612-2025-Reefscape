...
public class PoseEstimator extends SubsystemBase {
  ...
  public PoseEstimator() {
    ...
    drivePoseEstimator = new SwerveDrivePoseEstimator(
      ...
      m_drivetrain.getPigeonAngle(), 
      m_drivetrain.getSwervePositions(), 
      new Pose2d(),
      statesStdDev,
  ...
  public void periodic() {
    drivePoseEstimator.update(m_drivetrain.getPigeonAngle(), m_drivetrain.getSwervePositions());
    updatePoseEstimator();
 ...
 public void setCurrentPose(Pose2d newPose) {
   drivePoseEstimator.resetPosition(m_drivetrain.getPigeonAngle(), m_drivetrain.getSwervePositions(), newPose);
 }
